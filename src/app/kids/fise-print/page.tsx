    ...
    <div className="min-h-screen bg-slate-100 py-6 px-2 sm:py-10 sm:px-4">
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="space-y-8 sm:space-y-12">
          {/* FIȘA 1 */}
          <div className="print-card bg-white rounded-3xl border border-slate-200 p-4 sm:p-8 shadow-sm overflow-x-auto">
            <div className="border-b-2 border-dashed border-indigo-100 pb-4 text-center">
              <h1 className="text-xl sm:text-2xl font-black text-indigo-900">
                Aventura lui Pippy — Fișă Didactică 1
              </h1>
              <p className="text-[10px] sm:text-xs text-slate-500 font-bold mt-1 uppercase tracking-wider">
            ...
            <div className="mt-6 sm:mt-8 flex justify-center">
              <div className="grid grid-cols-4 gap-2 sm:gap-4 max-w-[280px] w-full aspect-square border-4 border-slate-300 p-2 sm:p-3 rounded-2xl bg-slate-50">
                {Array.from({ length: 16 }).map((_, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className="relative flex items-center justify-center rounded-xl border border-slate-300 bg-white font-bold text-base sm:text-lg aspect-square"
                    >
                      {esteStart && "🤖"}
                      {esteStar && "⭐"}
                      {esteTinta && "🏁"}
            ...
            <div className="mt-8 sm:mt-10">
              ...
              <div className="mt-3 flex flex-wrap gap-2 sm:gap-3">
                {Array.from({ length: 8 }).map((_, i) => (
                  <div
                    key={i}
                    className="h-8 w-8 sm:h-10 sm:w-10 rounded-lg border-2 border-slate-300 flex items-center justify-center font-bold text-slate-500 text-xs sm:text-sm bg-slate-50"
                  >
                    {i + 1}
                  </div>
                ))}
            ...
            <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row gap-3 justify-between border-t border-slate-100 pt-6 text-xs text-slate-500 font-medium">
          ...
          <div className="print-card print-break bg-white rounded-3xl border border-slate-200 p-4 sm:p-8 shadow-sm overflow-x-auto">
            <div className="border-b-2 border-dashed border-indigo-100 pb-4 text-center">
              <h1 className="text-xl sm:text-2xl font-black text-indigo-900">
            ...
            <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row gap-6 justify-center items-center">
              <div className="grid grid-cols-6 gap-1.5 max-w-[240px] w-full aspect-square border-4 border-slate-300 p-2 rounded-2xl bg-slate-50">
                {Array.from({ length: 36 }).map((_, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className={`relative flex items-center justify-center rounded-lg border text-xs sm:text-sm font-bold aspect-square ${
              ...
              <div className="border-2 border-dashed border-indigo-200 p-4 rounded-2xl bg-indigo-50/20 w-full max-w-[260px] font-sans">
                ...
                <div className="space-y-1 text-xs text-slate-600 font-mono">
                  ...
                  <div className="bg-indigo-100 border border-indigo-200 rounded p-1 ml-3">🚶 Mergi Dreapta</div>
                  <div className="bg-amber-100 border border-amber-200 rounded p-1 mt-1">Repetă de 5 ori:</div>
                  <div className="bg-indigo-100 border border-indigo-200 rounded p-1 ml-3">🚶 Mergi Jos</div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 sm:mt-10">
              ...
              <div className="mt-3 border border-slate-300 rounded-2xl h-40 bg-slate-50 p-4">
          ...
          <div className="print-card print-break bg-white rounded-3xl border border-slate-200 p-4 sm:p-8 shadow-sm overflow-x-auto">
            ...
            <div className="mt-6 sm:mt-8 flex justify-center">
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 max-w-[320px] w-full border-4 border-slate-300 p-2 sm:p-3 rounded-2xl bg-slate-50">
                <div className="flex items-center justify-center h-14 sm:h-16 bg-white border border-slate-300 rounded-xl font-bold text-xs sm:text-sm">🤖 (Start)</div>
                <div className="flex items-center justify-center h-14 sm:h-16 bg-white border border-slate-300 rounded-xl font-bold text-sm">⭐</div>
                <div className="flex items-center justify-center h-14 sm:h-16 bg-white border border-slate-300 rounded-xl font-bold text-sm">🟩</div>
                <div className="flex items-center justify-center h-14 sm:h-16 bg-white border border-slate-300 rounded-xl font-bold text-sm">🏁</div>
              </div>
            </div>
          ...
          <div className="print-card print-break bg-white rounded-3xl border border-slate-200 p-4 sm:p-8 shadow-sm overflow-x-auto">
            ...
            <div className="mt-6 sm:mt-8 flex justify-center">
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 max-w-[360px] w-full border-4 border-slate-300 p-2 sm:p-3 rounded-2xl bg-slate-50 text-center font-bold text-xs sm:text-sm">
                ...
                <div className="p-2 bg-white border rounded-xl col-span-2 sm:col-span-1">5. ⭐ 🏁</div>
              </div>
            </div>
            ...
            <div className="mt-8 sm:mt-10">
              ...
              <div className="mt-3 grid grid-cols-2 sm:grid-cols-5 gap-2 font-mono text-[11px] sm:text-xs text-center">
                <div className="p-2.5 bg-slate-100 border rounded-xl">Pas 1: stele = 0</div>
                <div className="p-2.5 bg-amber-50 border border-amber-300 rounded-xl font-bold">Pas 2: stele = ___</div>
                <div className="p-2.5 bg-amber-50 border border-amber-300 rounded-xl font-bold">Pas 3: stele = ___</div>
                <div className="p-2.5 bg-slate-100 border rounded-xl font-bold">Pas 4: stele = ___</div>
                <div className="p-2.5 bg-emerald-50 border border-emerald-300 rounded-xl font-bold col-span-2 sm:col-span-1">Pas 5: stele = ___</div>
              </div>
            </div>
