  ...
  return (
    <div className="bg-slate-50 text-slate-900 min-h-screen">
      <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6">
        ...
        <p className="mt-3 max-w-2xl text-slate-600 font-medium text-sm sm:text-base">
        ...
        <div className="mt-6 rounded-3xl border border-indigo-200 bg-indigo-50/60 p-5 text-xs sm:text-sm text-indigo-950">
        ...
        <dl className="mt-8 grid grid-cols-3 gap-4 sm:max-w-md">
          {[
            ...
            >
              <dt className="text-[10px] font-extrabold uppercase tracking-widest text-slate-500">{eticheta}</dt>
        ...
        <section className="mt-12">
          <h2 className="text-xl font-black text-slate-900">Șablonul celor 6 pași ai unei lecții</h2>
          <ol className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {structura.sablon_sublectii.map((s, i) => (
              ...
              >
                ...
                <p className="mt-1 font-bold text-slate-900 text-sm">{s.titlu}</p>
                <p className="mt-1 text-xs text-slate-500">{s.descriere}</p>
              </li>
            ))}
          </ol>
        </section>
            ...
            >
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <h3 className="mt-1 text-xl font-black text-slate-900">{c.titlu}</h3>
